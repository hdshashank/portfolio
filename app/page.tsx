...
export default function Home() {
  return (
    <main id="main-content">
      ...
      >
        <div className="min-w-0 w-full pt-[clamp(48px,7vh,86px)] pb-[clamp(38px,6vh,66px)] max-[560px]:pt-[clamp(46px,8vh,70px)] max-[560px]:pb-[42px]">
          ...
          <h1
            id="hero-title"
            className="m-0 max-w-[1130px] font-[var(--font-display)] text-[length:var(--heading-page-size)] leading-[.86] font-black tracking-[-.035em] uppercase max-[1101px]:max-w-full"
          >
            <span className="block w-fit whitespace-nowrap max-[1101px]:w-full max-[1101px]:text-balance max-[1101px]:whitespace-normal">
              Curious by nature.
            </span>
            <span className="relative mt-[.13em] block w-fit whitespace-nowrap text-[.88em] text-paper [text-shadow:.055em_.055em_0_color-mix(in_srgb,var(--blue-solid)_64%,transparent)] [-webkit-text-stroke:1.5px_var(--ink)] max-[1101px]:w-full max-[1101px]:text-balance max-[1101px]:whitespace-normal max-[560px]:mt-[.22em] max-[560px]:text-[.84em] max-[560px]:text-blue max-[560px]:[text-shadow:none] max-[560px]:[-webkit-text-stroke:0]">
              Engineer by practice.
            </span>
          </h1>

          <div className="mt-[clamp(32px,4vw,50px)] grid min-w-0 max-w-[1100px] grid-cols-[9px_minmax(0,1fr)] gap-[clamp(15px,2vw,23px)] before:bg-signal before:content-[''] max-[760px]:mt-[30px] max-[560px]:grid-cols-[6px_minmax(0,1fr)] max-[560px]:gap-[14px]">
            <p className="m-0 min-w-0 font-serif text-[clamp(17px,1.6vw,22px)] leading-[1.48] tracking-[-.01em] text-muted [overflow-wrap:anywhere] max-[560px]:text-base max-[560px]:leading-[1.46]">
          ...
          <div className="mt-[clamp(30px,4vw,48px)] flex flex-wrap gap-2.5 max-[560px]:mt-[30px] max-[560px]:flex-col">
            <a
              className="group inline-flex min-h-[50px] min-w-[216px] max-w-full items-center justify-between gap-[30px] border border-blue-solid bg-blue-solid px-4 py-3.5 font-mono text-[10px]/none font-bold tracking-[.08em] text-white uppercase transition-[color,background-color,border-color,box-shadow,transform] duration-[160ms] hover:-translate-x-0.5 hover:-translate-y-0.5 hover:border-blue hover:bg-transparent hover:text-ink hover:shadow-[5px_5px_0_var(--rule)] max-[560px]:w-full max-[560px]:min-w-0"
